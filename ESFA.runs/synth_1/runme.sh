...
HD_PWD='C:/Users/justi/OneDrive/Documents/Vivado/ESFA/ESFA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log congrueDownDesign.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source congrueDownDesign.tcl
