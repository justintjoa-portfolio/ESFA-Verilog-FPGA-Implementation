...
HD_PWD='C:/Users/justi/OneDrive/Documents/Vivado/ESFA/ESFA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ESFADesign.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ESFADesign.tcl -notrace
