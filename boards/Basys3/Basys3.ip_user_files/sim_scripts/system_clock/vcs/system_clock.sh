...
#
# Script generated by Vivado on Mon Sep 07 11:31:28 -1000 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : system_clock.sh
...
#
# Usage        : system_clock.sh
#                system_clock.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_clock.sh [-reset_run]
#                system_clock.sh [-reset_log]
#                system_clock.sh [-help]
#
...
#                script (type 'system_clock.sh -help' for more information).
#
...
# script info
echo -e "system_clock.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_clock.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.system_clock xil_defaultlib.glbl -o system_clock_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./system_clock_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key system_clock_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc system_clock_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./system_clock.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: system_clock.sh [-help]\n\
Usage: system_clock.sh [-step]\n\
Usage: system_clock.sh [-lib_map_path]\n\
Usage: system_clock.sh [-reset_run]\n\
Usage: system_clock.sh [-reset_log]\n\
Usage: system_clock.sh [-keep_index]\n\
Usage: system_clock.sh [-noclean_files]\n\n\
